...
import { Pager, Text, List } from '@writ/react';
import forThrough from '@writ/utils/for-through';

export const ExamplePager = () => {
    ...
    return (
        <>
            <List>
                <List.Head>
                    <Text theme='success' value='Pager' /> 是一个受控组件，必须提供 <Text theme='warning' value='onChange' />
                ...
                <List.Foot>
                    <Pager total={100} onChange={(pageNo, pageSize) => {
                        setPageNo(pageNo);
